...
The extraction model (`qwen2.5:7b`, ~4.7GB) is also pulled on first start. If you don't need automatic entity extraction, set `NOBRAINR_EXTRACTION_ENABLED=false` in `.env`.
